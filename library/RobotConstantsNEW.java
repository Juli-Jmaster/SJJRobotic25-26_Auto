...
@Configurable
public interface RobotConstantsNEW {
    ...
    //*padro pathing
    double massKG =11.5;
    double forwardVelocity = 70.53795;
    double strafeVelocity = 64.90787;
    double forwardDeceleration = -38.808;
    double lateralZDeceleration = -60.19;
