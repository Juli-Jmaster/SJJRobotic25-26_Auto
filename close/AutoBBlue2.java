...
@Autonomous
public class AutoBBlue2 extends OpMode {
    private TelemetryManager panelsTelemetry; // Panels Telemetry instance
    private Timer pathTimer;
    private AutoUtils autoUtils;
    private Follower follower;
    private PathsBBlue2 paths; // Paths defined in the Paths class
    ...
    public void init() {
        ...
        paths = new PathsBBlue2(follower); // Build paths
...
class PathsBBlue2 {
    ...
    public PathsBBlue2(Follower follower) {
        //start
