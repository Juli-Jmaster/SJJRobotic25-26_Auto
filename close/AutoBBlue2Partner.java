...
@Autonomous(name = "Blue Partner", group = "blue")
public class AutoBBlue2Partner extends OpMode {
    private TelemetryManager panelsTelemetry; // Panels Telemetry instance
    private Timer pathTimer;
    private AutoUtils autoUtils;
    private Follower follower;
    private PathsBBlue2Partner paths; // Paths defined in the Paths class
    ...
    public void init() {
        ...
        paths = new PathsBBlue2Partner(follower); // Build paths
...
class PathsBBlue2Partner {
    ...
    public PathsBBlue2Partner(Follower follower) {
        ...
        path3 = follower.pathBuilder().addPath( new BezierCurve(
                        PathBlue.pickup2Pose, PathBlue.clearGateControlPoseFrom1, PathBlue.clearGatePoseFromScore))
                .setLinearHeadingInterpolation(PathBlue.pickup2Pose.getHeading(), PathBlue.clearGatePoseFromScore.getHeading())
                .build();
        path4 = follower.pathBuilder().addPath( new BezierLine(
                        PathBlue.clearGatePoseFromScore, PathBlue.scorePose))
                .setLinearHeadingInterpolation(PathBlue.clearGatePoseFromScore.getHeading(), PathBlue.scorePose.getHeading())
                .build();
