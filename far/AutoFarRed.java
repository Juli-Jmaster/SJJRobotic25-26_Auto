...
import org.firstinspires.ftc.teamcode.paths.PathRedFar;
...
public class AutoFarRed extends OpMode {
    ...
    private PathsFarRed paths; // Paths defined in the Paths class
    ...
    public void init() {
        ...
        paths = new PathsFarRed(follower); // Build paths
...
class PathsFarRed{
    ...
    public PathsFarRed(Follower follower) {
        ...
        path4 = follower.pathBuilder().addPath(new BezierLine(
                ...
                .setLinearHeadingInterpolation(PathRedFar.pickupHumanPose.getHeading(), PathRedFar.scorePose.getHeading())
                .build();
